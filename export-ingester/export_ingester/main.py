...
async def main():
    ...
    async with get_managed_export_ingester(settings) as export_ingester:
        ...
        archive_command = "sbatch --time=22:00:00 --partition=staging --nodes=1 --ntasks=1 --job-name=surf_archive --output=archive_%j.out --error=archive_%j.err --wrap='surf-archiver-cli archive --mode=images 2024-12-19'"
